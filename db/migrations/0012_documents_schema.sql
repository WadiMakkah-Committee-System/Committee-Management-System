...
-- Claude بتاريخ 2026-08-26. صفوف كتالوج صلاحيات الوثائق الجديدة
-- (documents.update / documents.delete / documents.download وصلاحيات
-- document_categories) لم تُدرج تلقائيًا لأن إدراجها على جدول permissions
-- رفضه المصنّف الآلي للأمان في بيئة Claude كإجراء حسّاس. الـSQL الخاص
-- بها موجود في وصف Pull Request هذا ليُنفَّذ يدويًا من قبل الفريق.
